...
def checkKREN(contents):
    ...
    subEditorLogger.info("checkKREN")
...
def sortTXT(contents):
    ...
    contents = pStyle15.sub(r'', contents)
    contents = pStyle16.sub(r'\r\n', contents)
    contents = pStyle17.sub(r'', contents)
    contents = pStyle18.sub(r' ', contents)
    contents = pStyle19.sub(r' ', contents)
    ...
    contentsKR = pStyleKR.findall(contents)
    contentsEN = pStyleEN.findall(contents)
